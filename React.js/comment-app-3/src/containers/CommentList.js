...
class CommentListContainer extends Component {
    ...
    _loadComments() {
        ...
        // this.props.initComments 是 connect 传进来的，可以把数据初始化到 state 里面去
        this.props.initComments(comments)
    }

    handleDeleteComment(index) {
        const { comments } = this.props
        // props 是不能变的，所以这里新建一个删除了待定下标的评论列表
        const newComments = [
        ...
        if (this.props.onDeleteComment) {
            // this.props.onDeleteComment 是 connect 传进来的，会 dispatch 一个 action 取删除评论
